...
<HTML>
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProductServlet?method=productAdd" method="post" enctype="multipart/form-data">
			&nbsp;
